                        ...
                        <div class="single-product-details clearfix">
                            <div class="col-md-5">
                                <div class="single-slider-item">
                                    <ul class="owl-slider">
                                        <li class="item">
                                            <img src="" alt="" class="hn-img img-responsive">
                                        </li>
                                        <li class="item">
                                            <img src="" alt="" class="hn-img img-responsive">
                                        </li>
                            ...
                            <div class="col-md-7">
                                <div class="right-content">
                                    <div class="product-info">
                                        <h4 class="hn-product-name"></h4>
                                        <div class="hn-price" style="display: none;">{{ $price }}</div>
                                        <div class="product-description">
                                            <h5 class="small-title">DESCRIPTION</h5>
                                            <div class="hn-description"></div>
                                        </div>
                                        <div class="actions">
                                            <ul>
                                                ...
                                                <li><a class="hn-img zoom" href="assets/images/gallery_men/single-shop-details/big/image1xxl.jpg"><span class="arrow_expand"></span></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
